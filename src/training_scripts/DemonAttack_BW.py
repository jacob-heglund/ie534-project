...
is_load = True
off_set = 19900000
load_path = './tar_ckp/target_DemonAttackNoFrameskip-v0_'+str(off_set)+'.ckpt'
out_dir = '/u/training/tra456/scratch/project/DemonAttack/'
start_frame = off_set
...
for frame_idx in range(start_frame, num_frames + start_frame):
    ...
    if (frame_idx%100000==0):
        ...
        np.save(out_dir + 'losses_{}_{}.npy'.format(env_id, frame_idx),np.array(losses))
        np.save(out_dir + 'rewards_{}_{}.npy'.format(env_id,frame_idx),np.array(all_rewards))
